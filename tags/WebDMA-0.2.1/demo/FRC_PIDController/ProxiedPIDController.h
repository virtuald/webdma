...
#ifndef ProxiedPIDController_H_
#define ProxiedPIDController_H_
 ...
 * PIDOutput
 */
class ProxiedPIDController
{
private:
	FloatProxy mp_P;			// factor for "proportional" control
	FloatProxy mp_I;			// factor for "integral" control
	FloatProxy mp_D;			// factor for "derivative" control
	...
	void Calculate();
	DISALLOW_COPY_AND_ASSIGN(ProxiedPIDController);
public:
	ProxiedPIDController(float p, float i, float d,
